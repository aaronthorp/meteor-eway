...
eWay = function(opt) {
  ...
  this.token = function(mode, transaction) {
    ...
    switch (mode) {
      ...
      case 'queryCustomer':
        return({TrxnStatus: false, TrxnError: 'Token Transaction: "queryCustomer" function not yet implemented'});
      case 'processPayment':
        return({TrxnStatus: false, TrxnError: 'Token Transaction: "processPayment" function not yet implemented'});
      case 'queryPayment':
        return({TrxnStatus: false, TrxnError: 'Token Transaction: "queryPayment" function not yet implemented'});
      default:
